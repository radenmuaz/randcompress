...
chunk_n_timesteps (level 0) = 16.

UNTESTED AT THIS SCALE.

  uv run python -m enfrac.download_data --which enwik9 --out_dir datasets
  uv run python -m enfrac_zero.train --config enfrac_zero/configs/enwik9_longleaf_64kb.py --log_dir logs/enfrac_zero/enwik9_longleaf_64kb
"""
...
train = dict(
    ...
    log_dir="logs/enfrac_zero/enwik9_longleaf_64kb",
    lr=3e-3,
    grad_clip=1.0,
    remat_time="1.0",
    remat_depth="0.5",
