"""
Range codec — ctypes binding to rc_codec.c. Shared, backend-agnostic (pure numpy in/out): the
JAX port doesn't change this at all vs. overfitter_peft/codec.py -- "compress/decompress stays C".
