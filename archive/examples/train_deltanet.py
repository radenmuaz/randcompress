"""
Train Gated DeltaNet (vector gate) with HiRA + SinkGD.
...
def main():
    ...
    print(f"Model : deltanet  d={mcfg.d_model}  nh={mcfg.num_heads}"
          f"  layers={mcfg.num_layers}  r={mcfg.lora_r}")
